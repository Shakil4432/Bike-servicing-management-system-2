...
router.put("/:customerId", customer_controller_1.CustomerController.customerUpdateById);
router.delete("/:customerId", customer_controller_1.CustomerController.deleteCustomerById);
